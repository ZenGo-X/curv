...
impl Party1SecondMessage{
    pub fn reveal(party2seed : &Secp256k1Scalar, party1seed: &Secp256k1Scalar, party1blinding: &Secp256k1Scalar) -> (Party1SecondMessage, Secp256k1Scalar){
        ...
        (Party1SecondMessage{proof, seed: party1seed.clone()}, ECScalar::from_big_int(&coin_flip_result))
    }
}

// party2 finalize
pub fn finalize(proof : &PedersenBlindingProof, party2seed: &Secp256k1Scalar, party1comm: &Secp256k1Point) -> Secp256k1Scalar{
...
mod tests {
    ...
    pub fn test_coin_toss(){
        ...
        let (party1_second_message, random1) = Party1SecondMessage::reveal(&party2_first_message.seed,&m1, &r1);
        let random2 = finalize(&party1_second_message.proof, &party2_first_message.seed,&party1_first_message.proof.com);
