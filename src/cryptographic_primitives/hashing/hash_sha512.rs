...
mod tests {
    ...
    fn vector_sha512_test() {
        ...
        // 512 bit message
        let result: BigInt = HSha512::create_hash(&vec![&BigInt::from_hex(
        ...
        // 1024 bit message
        let result: BigInt = HSha512::create_hash(&vec![&BigInt::from_hex("").unwrap()]);
        assert_eq!(
            result.to_hex(),
