...
mod tests {
    ...
    fn vector_sha256_test() {
        ...
        // 512 bit message
        let result: BigInt = HSha256::create_hash(&vec![&BigInt::from_hex("5a86b737eaea8ee976a0a24da63e7ed7eefad18a101c1211e2b3650c5187c2a8a650547208251f6d4237e661c7bf4c77f335390394c37fa1a9f9be836ac28509").unwrap()]);
        assert_eq!(
            result.to_hex(),
